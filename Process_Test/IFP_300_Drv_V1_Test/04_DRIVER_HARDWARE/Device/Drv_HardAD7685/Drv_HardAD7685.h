...
#ifndef _DRV_HARDAD7685_H_
#define _DRV_HARDAD7685_H_ 
...
/*AD7685模块状态枚举*/
typedef enum{
	HARDAD7685_UNDEFINED = 0,				/*未初始化*/
	HARDAD7685_READY  = 1					/*可用*/
} DRV_HARDAD7685_STATUS_ENUM;

/*AD7685模块结构体*/
typedef struct{
	/*------------------------------变量*/
	DRV_HARDAD7685_STATUS_ENUM status;			/*该AD7685模块的状态*/
	uint16_t tx_buffer;						/*发送缓存*/
	uint16_t rx_buffer;						/*接收缓存*/
	/*------------------------------变常*/
	/*------------------------------常量*/
	DRV_HARDAD7685_ENUM id;						/*AD7685模块id*/
...
*/
extern DRV_HARDAD7685_TYPE* Drv_HardAd7685Init(DRV_HARDAD7685_ENUM id, BSP_SPI_ENUM spi_number, \
...
*/
extern uint16_t HardAd7685OneAcq(DRV_HARDAD7685_TYPE* p_unit);

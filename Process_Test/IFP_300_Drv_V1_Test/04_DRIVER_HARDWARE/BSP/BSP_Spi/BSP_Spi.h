...
/* 初始化SPI接口
  ...
  返回值：成功true，失败false
*/
extern bool BSP_InitSpiMaster16Bit( BSP_SPI_ENUM spi_number, \
...
extern bool BSP_InitSpiMaster8Bit( BSP_SPI_ENUM spi_number, \
                                   BSP_PORT_ENUM nss_port_number, BSP_PIN_ENUM nss_pin_number, \
                                   BSP_PORT_ENUM sck_port_number, BSP_PIN_ENUM sck_pin_number, \
                                   BSP_PORT_ENUM miso_port_number, BSP_PIN_ENUM miso_pin_number, \
                                   BSP_PORT_ENUM mosi_port_number, BSP_PIN_ENUM mosi_pin_number );
...
extern uint16_t BSP_SpiReceiveData(BSP_SPI_ENUM spi_number);
...
*/
extern FlagStatus BSP_SpiGetStatus(BSP_SPI_ENUM spi_number, BSP_SPI_STATUS_TYPE_ENUM type);

...
#define VOLTAGE_THRESHOLD_PERCENTAGE        (2120)//(2)    // 2120 (3.42) 2141 (3.45)
#define VOLTAGE_THRESHOLD_PROMPT            (2160)//(15)   // 2160(3.48) 2172 (3.5)
...
#define VOLTAGE_AD_6_VALUES                 (2265)  //(3.65)	//(2234)  //(3.6)
...
#define MAIN_DENSITY_DIS10_CON_ID  (10)
...
#define CURVE_ON           (0x01)
#define CURVE_OFF          (0x00)

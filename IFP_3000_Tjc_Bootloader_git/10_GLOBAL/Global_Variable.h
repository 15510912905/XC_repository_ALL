...
#define USART4_REC_LEN  			(4096)  	//定义最大接收字节数 200
...
extern uint8_t  g_Usart_Tx_Buf[USART_REC_LEN];   //接收缓冲,最大USART_REC_LEN个字节.末字节为换行符 
...
extern uint8_t  g_Usart4_Tx_Buf[USART4_REC_LEN]; //接收缓冲,最大USART_REC_LEN个字节.末字节为换行符 
...
extern OS_SEM g_TjcUpdata;                                                    /*  */
extern OS_SEM g_TjcUpgarde; 
...
extern uint8_t g_ServerIPAddr[16],g_ServerPort[5];

...
//	uint16_t uLength = 0;
//	
//	sprintf( (char *)(uReplyData),"%s%d","page ",uPage );
...
//	uint16_t uLength = 0;
//	
//	uTjc4832tPageTextId( page_id,uReplyData );
//	uLength = strlen( (const char*)uReplyData );
//	uTjc4832tTextId( control_id,uReplyData+uLength );
//	uLength = strlen( (const char*)uReplyData );
//	sprintf( (char *)(uReplyData+uLength),"%s",(const char*)str );
//	uLength = strlen((const char *)uReplyData);
//	sprintf( (char *)uReplyData+uLength,"%s","\"" );
//	uLength = strlen( (const char*)uReplyData );
//	
//	sprintf( (char *)(uReplyData+uLength),"%c%c%c",0xFF,0xFF,0xFF );
//	uLength =  strlen((const char *)uReplyData);
...
//	uint16_t uLength = 0;
//	
//	sprintf( (char *)(uReplyData),"%s",(const char*)"tsw " );
//	uLength = strlen((const char *)uReplyData);
//	sprintf( (char *)(uReplyData+uLength),"%d%c",control_id,',' );
//	uLength = strlen( (const char*)uReplyData );
//	sprintf( (char *)(uReplyData+uLength),"%d",uenable );	
//	uLength = strlen( (const char*)uReplyData );
//	
//	sprintf( (char *)(uReplyData+uLength),"%c%c%c",0xFF,0xFF,0xFF );
//	uLength =  strlen((const char *)uReplyData);
